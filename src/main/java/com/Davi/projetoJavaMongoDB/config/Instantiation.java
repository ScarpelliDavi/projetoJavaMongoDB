...
import com.Davi.projetoJavaMongoDB.dto.AuthorDTO;
...
public class Instantiation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Post p1 = new Post(null, sdf.parse("21/03/2018").toInstant(), "Partiu Viagem", "Vou viajar pra Sao Paulo. Abracos!!", new AuthorDTO(maria));
        Post p2 = new Post(null, sdf.parse("23/03/2018").toInstant(), "Bom dia", "Acordei feliz hoje", new AuthorDTO(maria));
